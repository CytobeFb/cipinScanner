...
public class StatusBarUtil {
    ...
    /**
     * 计算状态栏颜色
     *Develop/android/trunk/wj/EnforceManager/app/src/main/java/com/enforce/manager/utils/StatusBarUtil.java
     * @param color color值
     * @param alpha alpha值
     * @return 最终的状态栏颜色
     */
    ...
    //设置下拉刷新的控件出现的位置
    public static void showSwipeViewOff(Context context, int appBarHeight, SwipeRefreshLayout swipeRefreshLayout)
    {
// set progress view offset
        int actionBarSize = getActionBarSize(context);
        int progressViewStart = context.getResources().getDimensionPixelSize(appBarHeight) - actionBarSize;
