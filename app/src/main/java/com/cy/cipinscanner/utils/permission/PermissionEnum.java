...
public enum PermissionEnum {
    WRITE_SETTINGS(Manifest.permission.WRITE_SETTINGS,"设置"),
    ...
    WAKE_LOCK(Manifest.permission.WAKE_LOCK,"锁屏"),
    DISABLE_KEYGUARD(Manifest.permission.DISABLE_KEYGUARD,"首页"),
